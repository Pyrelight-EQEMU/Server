...
public:
	...
	bool   PL_DoHeroicDEXMeleeCriticalReroll(Mob *defender, DamageHitInfo &hit, ExtraAttackOptions *opts, bool crit = false);
	bool   PL_DoHeroicDEXSpellCriticalReroll(Mob *defender, int spell_critical, bool crit = false);
	...
	bool   PL_DoHeroicDEXMultiRangedAttack(uint64 skill, Mob* other, bool successful_attack = true);
...
protected:
	...
	void _TryCombatProcs(const EQ::ItemInstance* weapon, Mob *on, uint16 hand = EQ::invslot::slotPrimary, const EQ::ItemData* weapon_data = nullptr);	
