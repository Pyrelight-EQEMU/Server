...
RULE_REAL(Character, Pyrelight_hINT_SpellDamage, 1, "")
RULE_REAL(Character, Pyrelight_hINT_RunePower, 1, "")
...
RULE_REAL(Character, Pyrelight_hWIS_HealPower, 1, "")
RULE_REAL(Character, Pyrelight_hWIS_BuffPower, 1, "")
...
RULE_BOOL(Character, Pyrelight_hStat_Randomize, true, "")
RULE_REAL(Character, Pyrelight_hStat_RandomizationFactor, 0.5, "")
