...
RULE_REAL(Character, Pyrelight_hSTR_DmgBonus, 3.0, "Percentage that each point of Heroic STR should add to melee & ranged damage.")
RULE_REAL(Character, Pyrelight_hSTA_DmgReduction, 10, "Number of points of damage that each point of Heroic STA should mitigate.")
RULE_REAL(Character, Pyrelight_hAGI_EvasionReroll, 1, "Percentage chance of a reroll for evasion skills which each point of Heroic AGI should add.")
RULE_REAL(Character, Pyrelight_hDEX_CriticalReroll, 1, "Percentage chance of a reroll for melee, ranged, and spell criticals that each point of Heroic DEX should add")
RULE_BOOL(Character, Pyrelight_hCHA_ResistReroll, true, "Allow for Heroic Charisma to reroll spell resistance checks.")
...
RULE_BOOL(Items, LoreEquipOnly, true, "Enable this to allow multiple Lore items in inventory, but not equipped. Bags in root slots of general inventory are considered to be 'equipped'.")
